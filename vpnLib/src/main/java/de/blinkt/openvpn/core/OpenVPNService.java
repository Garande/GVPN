...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    private static Class<? extends AppCompatActivity> mNotificationActivityClass;
...
//    private final NetworkSpace mRoutesv6 = new NetworkSpace();
//    private final Object mProcessLock = new Object();
//    private NotificationChannel lastChannel;
//    private Thread mProcessThread = null;
//    private VpnProfile mProfile;
//    private String mDomain = null;
//    private CIDRIP mLocalIP = null;
...
////    private String createNotificationChannel(String channelId, String channelName) {
////        NotificationChannel chan = new NotificationChannel(channelId,
////                channelName, NotificationManager.IMP);
////        chan.setLightColor(Color.BLUE);
////        chan.setLockscreenVisibility(Notification.VISIBILITY_PRIVATE);
////        NotificationManager service = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
////        service.createNotificationChannel(chan);
...
////    }
//
//    private void showNotification(final String msg, String tickerText, @NonNull String channelId,
//                                  long when, ConnectionStatus status, Intent intent) {
//
...
//
//        if(mProfile != null)
//            builder.setContentTitle(getString(R.string.notifcation_title, mProfile.mName));
//        else
...
//        // Try to set the priority available since API 16 (Jellybean)
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
//            jbNotificationExtras(priority, builder);
//            addVpnActionsToNotification(builder);
//        }
//
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
//            lpNotificationExtras(builder, Notification.CATEGORY_SERVICE);
//
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
//            //noinspection NewApi
...
//            if (mProfile != null)
//                //noinspection NewApi
//                builder.setShortcutId(mProfile.getUUIDString());
//
//        }
//
//        if (tickerText != null && !tickerText.equals(""))
...
//
//            if (lastChannel != null && !notificationChannel.equals(lastChannel)) {
//                // Cancel old notification
...
//                // Ignore for now ...
//                iae.printStackTrace();
//                Log.e(OpenVPNService.class.getSimpleName(), null, iae);
//            }
//        mDeviceStateReceiver = null;
//
//        /*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
